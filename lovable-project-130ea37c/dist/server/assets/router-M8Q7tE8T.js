...
const appCss = "/assets/styles-BuxAAlvy.css";
...
const $$splitComponentImporter$3 = () => import("./contato-CtRGPzKP.js");
const Route$3 = createFileRoute("/contato")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Entre em contato. Análise gratuita do seu caso de bloqueio em redes sociais."
    }, {
      property: "og:title",
      content: "Contato — Meu Direito Já"
    }, {
      property: "og:description",
      content: "Análise gratuita. Resposta em até 24h."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./blog-BdscYQ87.js");
const Route$2 = createFileRoute("/blog")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Artigos sobre bloqueio de Instagram, WhatsApp banido, recuperação de contas e seus direitos digitais."
    }, {
      property: "og:title",
      content: "Blog Meu Direito Já"
    }, {
      property: "og:description",
      content: "Conteúdo sobre direitos digitais, bloqueios e indenizações."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const lawyerImg = "/assets/lawyer-dgBhd1_X.png";
const $$splitComponentImporter$1 = () => import("./advogados-DgINJWVG.js");
const Route$1 = createFileRoute("/advogados")({
  head: () => ({
    meta: [{
      title: "Para Advogados — Receba leads qualificados | Meu Direito Já"
    }, {
      name: "description",
      content: "Receba clientes qualificados todos os meses no nicho de bloqueio em redes sociais. Plataforma de leads para advogados."
    }, {
      property: "og:title",
      content: "Para Advogados — Leads qualificados todos os meses"
    }, {
      property: "og:description",
      content: "Escale seu escritório com leads filtrados em direito digital."
    }, {
      property: "og:image",
      content: lawyerImg
    }]
...
const heroImg = "/assets/hero-kdCKei3e.jpg";
const $$splitComponentImporter = () => import("./index-D6DAWQre.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Teve Instagram, WhatsApp, Facebook ou TikTok bloqueado? Conectamos você a advogados especialistas. Análise gratuita."
    }, {
      property: "og:title",
      content: "Meu Direito Já — Recupere sua conta bloqueada"
    }, {
      property: "og:description",
      content: "Análise gratuita do seu caso. Recuperação e indenização por bloqueio em redes sociais."
    }, {
      property: "og:image",
      content: heroImg
    }]
...
const AdvogadosRoute = Route$1.update({
  id: "/advogados",
  path: "/advogados",
  getParentRoute: () => Route$4
});
